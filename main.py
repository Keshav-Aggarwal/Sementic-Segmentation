...
def optimize(nn_last_layer, correct_label, learning_rate, num_classes):
    ...
    """
    # TODO: Implement function
    logits = tf.reshape(nn_last_layer,( -1, num_classes), name = "reshape_output")
...
def run():
    ...
    with tf.Session() as sess:
        ...
        logits, optimizer_op, loss = optimize(out_layer, correct_label, learning_rate, num_classes)

        # TODO: Train NN using the train_nn function
        train_nn(sess, epochs, batch_size, get_batches_fn, optimizer_op, loss, image_input,
             correct_label, keep_prob, learning_rate)
